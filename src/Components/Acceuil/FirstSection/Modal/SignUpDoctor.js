...
function SignUp()
{
    ...
    function validSpeciality(e)
    {
      ...
      if (valid===false) {
        Speciality.className="form-control is-invalid"
        
      }
      else
      {
        Speciality.className="form-control is-valid"
      }
    ...
    function validCnomCode()
    {
      var valid=true
      
      var CnomCode=document.getElementById("CNOM-code")
      if (CnomCode.value==="") 
      {
        valid=false
      }else if (!isnumber(CnomCode.value))
      {
        valid=false
      }
      else if(CnomCode.value.length!==5)
      {
        valid=false
      }
      ...
      if(valid!==true)
      {
        CnomCode.className="form-control is-invalid"
        
      }
      else
      {
        CnomCode.className="form-control is-valid"
      }
      return valid
    }
    ...
    function next()
    {     
      if((validCivility())&&(validFirstName())&&(validLastName())&&(validPhoneNumber())&&(validCnomCode())&&(validSpeciality()))
      {
        changer()
      }
    }
          ...
          <form onSubmit={verif}> 
            <div className="container-fluid">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="form-group">
                    ...
                    <select className="form-control" type="select" name="State-of-residence" id="State-of-residence">
                      <option value="" defaultValue disabled>Choose State Of Residence</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="form-group">
                    <label className="from-label" htmlFor="Area-of-practice">Area of practice </label>
                    <select className="form-control" type="select" name="Area-of-practice" id="Area-of-practice">
                    <option value="" selected disabled>Choose Your Area Of Practice</option>  
                    </select>
                  </div>  
                </div>
                <div className="col-lg-6 col-md-12 col-sm-12">
                  <div className="form-group">
                    <label className="from-label" htmlFor="Speciality">Speciality</label>
                    <select className="form-control" type="select" name="Speciality" id="Speciality ">
                      <option value="" selected disabled>Choose Your Speciality</option>
                      <option value="Mrs" >Mrs</option>
                    </select>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="offset-lg-3 offset-md-1 offset-sm-1 col-lg-6 col-md-10 col-sm-10">
                  <div className="form-group">
                    ...
                    <label className="from-label" htmlFor="CNOM-code">CNOM-code</label>
                    <input className="form-control" type="text" name="CNOM-code" onChange={validCnomCode} id="CNOM-code" />
                  </div>  
                </div>
